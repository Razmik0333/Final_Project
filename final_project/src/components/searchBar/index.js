        ...
        <>
            <div className="container">
                    ...
                    <div className="searchings">
                        ...
                        <button className="input_button" ><img className="icon_search" src="/icons/156545.png" alt="serach"/></button>
                    </div>
                    <div className="action">
                        <div><img className="icon_user" src = "/icons/958588.png" alt="icon"/></div>
                        <div><NavLink  className="action_btn icon_user" to={'/registration'}> Մուտք </NavLink></div>
                    </div>
